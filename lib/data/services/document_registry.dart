...
final List<_DocumentSeed> _documentSeeds = [
  _DocumentSeed(
    ...
    engTitle: 'Stack Proof · Architecture Validation',
    ruTitle: 'Пруф стека · Архитектурная валидация',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Stack Proof · Architecture Validation (Full)',
    ruTitle: 'Пруф стека · Архитектура (полная версия)',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Market Bridge · Marketplace Access',
    ruTitle: 'Маркет-мост · Доступ на рынок',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Market Bridge · Marketplace Access (Full)',
    ruTitle: 'Маркет-мост · Доступ на рынок (полная версия)',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Launch Blueprint · Solution Pathing',
    ruTitle: 'Блюпринт запуска · Карта решений',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Launch Blueprint · Solution Pathing (Full)',
    ruTitle: 'Блюпринт запуска · Карта решений (полная версия)',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Value Engine · Value & Pricing',
    ruTitle: 'Модель ценности · Ценность и прайсинг',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Value Engine · Value & Pricing (Full)',
    ruTitle: 'Модель ценности · Ценность и прайсинг (полная версия)',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Market Bridge · Compliance Checklist',
    ruTitle: 'Маркет-мост · чек-лист комплаенса',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Launch Blueprint · Decision Log',
    ruTitle: 'Блюпринт запуска · журнал решений',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Value Engine · Pricing Table',
    ruTitle: 'Модель ценности · таблица прайсинга',
  ),
  _DocumentSeed(
    ...
    engTitle: 'Value Engine · Value Model Results',
    ruTitle: 'Модель ценности · результаты модели ценности',
  ),
  _DocumentSeed(
    slug: 'dr3_value_pricing',
    kind: DocumentKind.note,
    ...
    engTitle: 'Value Engine · Pricing Cheat Sheet',
    ruTitle: 'Модель ценности · шпаргалка по прайсингу',
  ),
  _DocumentSeed(
